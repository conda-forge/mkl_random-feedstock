...
pixi global install mkl_random
```
...
It is possible to list all of the versions of `mkl_random` available on your platform:
...
```
pixi search mkl_random --channel conda-forge
```
